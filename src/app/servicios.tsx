...
const ServiciosContainer = () => {
  ...
  <div className="flex flex-col items-center">
    ...
    <p className="mt-4 text-center">Networking para proveedores de servicios</p>
        ...
        {expanded && (
          <div className="flex grid grid-cols-1 md:grid-cols-1 items-center gap-5 md:gap-8 p-10 md:flex-row md:items-start md:justify-center expandable-container">
            
            <p className="text-3xl bg-gradient-to-r from-blue-500 to-red-500 text-transparent bg-clip-text ">Soporte IT Online:</p>
            <ul>
              <li>Mediante un sistema de ticket vía Email mantenemos su empresa en correcto funcionamiento 24×7 los 365 días del año.</li>
            </ul>
            
            <p className="text-3xl bg-gradient-to-r from-blue-500 to-red-500 text-transparent bg-clip-text ">Redes:</p>
            <ul>
              <li>Llevamos a cabo la implementación y diseño de sistemas de cableado estructurado, abarcando CAT5 / CAT6 y fibra óptica. Nos encargamos de instalar u organizar racks y realizar mejoras en su disposición.</li>
            </ul>
            ...
            <ul>
              <li>Instalamos cámaras IP y sistemas de CCTV así como también soluciones para el control de acceso.</li>
            </ul>
...
Disponemos de una extensa red de colaboradores tecnológicos que nos capacitan para ofrecer las últimas innovaciones en software y hardware, asegurándonos de mantenernos al día con los requisitos específicos de su empresa o comercio.</li>
            ...
            <ul>
              <li>Contratos con diferentes opciones de SLA (tiempo de respuesta y solución de problemas). Respuesta telefónica y contacto directo en caso de urgencia o denegación de servicio.</li>
            </ul>
